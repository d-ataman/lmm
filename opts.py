...
def model_opts(parser):
    ...
    group.add_argument('-src_data_type', default="words",
                       help="""Type of the source input.
                       Options are [words|img|trigrams|characters].""")
    group.add_argument('-tgt_data_type', default="words",
                       help="""Type of the target input.
                       Options are [words|img|characters].""")
    ...
    group.add_argument('-decoder_type', type=str, default='rnn',
                       choices=['rnn', 'transformer', 'cnn', 'charrnn', 'inputfeed_charrnn', 'vae_charrnn'],
                       help="""Type of decoder layer to use. Non-RNN layers
                       are experimental. Options are
                       [rnn|transformer|cnn|trigramrnn].""")
...
def train_opts(parser):
    ...
    # Pretrained encoder
    group.add_argument('-pre_encoder', default='', type=str,
                       help="""If a valid path is specified, then this will load
                       a pretrained model, initialize the encoder with pre-trained 
                       weights and resume training the decoder.
                       See README for specific formatting instructions.""")
    ...
    group.add_argument('-adam_beta2', type=float, default=0.98,
...
def translate_opts(parser):
    ...
    group = parser.add_argument_group('Data')
    group.add_argument('-src_data_type', default="words",
                       help="Type of the source input. Options: [words|trigrams|characters|img].")
    group.add_argument('-tgt_data_type', default="words",
                       help="Type of the source input. Options: [words|characters|img].")
